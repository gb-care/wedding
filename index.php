...
<header class="w3-display-container w3-wide bgimg w3-grayscale-min" id="home">
  <div class="w3-display-middle w3-text-white w3-center">
    <h1 class="w3-jumbo">Novita & Brian</h1>
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    ...
    <a href="#us" style="width:25%" class="w3-bar-item w3-button">Novita & Brian</a>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min w3-center" id="wedding">
  <div class="w3-content">
    ...
    <img class="w3-round-large w3-grayscale-min" src="1.jpg" style="width:100%;margin:64px 0">
    <div class="w3-row">
      <div class="w3-half">
        <h2>When</h2>
      ...
      <div class="w3-half">
        <h2>Where</h2>
        <p>Some place, around the world</p>
        <p>Some where, around the city</p>
      </div>
    </div>
  </div>
</div>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-center w3-wide" id="rsvp">
  ...
  <p class="w3-large">Kindly Respond By Today</p>
  <p class="w3-xlarge">
...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="padding:32px;max-width:600px">
    <div class="w3-container w3-white w3-center">
      ...
      <p><i>Sincerely, Novita & Brian</i></p>
      <div class="w3-row">
        <div class="w3-half">
...
<footer class="w3-center w3-black w3-padding-16">
  <p>Powered by <a href="###" title="Our Dreams" target="_blank" class="w3-hover-text-green">Our Dreams Together</a></p>
</footer>
